                  ...
                  <div className="space-y-4">
                    <motion.div
                      ...
                      <div className="relative">
                        <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-black/60 transition-colors" />
                        <Input
                              value={adminUser}
                    ...
                    <motion.div
                      ...
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-black/60 transition-colors" />
                        <Input
              ...
              <motion.div
                ...
                className="space-y-5 py-4">
                  ...
                  transition={{ delay: 0.3 }}>
                    ...
                    <div className="relative">
                      <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-black/60 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <motion.div
                ...
                className="space-y-5 py-4">
                  ...
                  transition={{ delay: 0.3 }}>
                    ...
                    <div className="relative">
                      <KeyRound className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-black/60 transition-colors" />
                      <input
                        type="text"
                        value={otpCode}
                  ...
                  transition={{ delay: 0.5 }}>
                    ...
                    <div className="relative">
                      <CheckCircle2 className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-black/60 transition-colors" />
                      <input
                        type="password"
